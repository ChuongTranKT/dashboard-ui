...
const RecentTransaction = () => {
  return (
    <section id="recent-transaction" className="flex flex-col gap-3 px-6 ">
      <div>
        <p className="text-base font-semibold">Recent Transaction</p>
      </div>
      <div className="bg-white flex max-w-sm flex-col justify-between gap-3 rounded-2xl p-5 lg:h-48 xl:h-[14rem]">
        <div className="flex-between w-full">
          <div className="flex items-center justify-start gap-4 lg:gap-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-xs font-normal text-light_blue lg:text-[0.6rem]">
                28 January 2021
              </p>
            </div>
          </div>
